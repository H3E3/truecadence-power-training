...
""", unsafe_allow_html=True)
    ...
    st.markdown("""
<div class="tc-section-title">第一次使用:按这 4 步走就够了</div>
<div class="tc-grid-4">
    <div class="tc-card tc-step"><div class="tc-step-num">STEP 01</div><div class="title">👤 我的档案</div><div class="text">先填写体重、FTP、最大心率和训练目标。没有 FTP 也可以先跳过,系统会给参考估算。</div></div>
    <div class="tc-card tc-step"><div class="tc-step-num">STEP 02</div><div class="title">📥 导入数据</div><div class="text">上传 FIT,或从 Intervals.icu 导入最近训练。新手建议先导入最近 4-12 周。</div></div>
    <div class="tc-card tc-step"><div class="tc-step-num">STEP 03</div><div class="title">📊 我的分析</div><div class="text">查看功率能力、AI 分析、恢复睡眠和营养补给。先理解现状,不急着加量。</div></div>
    <div class="tc-card tc-step"><div class="tc-step-num">STEP 04</div><div class="title">📋 训练建议</div><div class="text">先看训练负荷,再生成训练课表,训练后填写反馈,让后续建议越来越贴近你。</div></div>
</div>

<div class="tc-section-title">导航已经按新手流程整理</div>
<div class="tc-grid-3">
    <div class="tc-card"><div class="icon">📥</div><div class="title">不知道点哪里?先去"导入数据"</div><div class="text">所有上传、平台导入和未来 Strava/Garmin 接入都会集中在这里。</div></div>
    <div class="tc-card"><div class="icon">📊</div><div class="title">想看结果?去"我的分析"</div><div class="text">功率仪表盘、AI 分析、恢复睡眠和营养补给都归到一个入口。</div></div>
    <div class="tc-card"><div class="icon">📋</div><div class="title">想知道怎么练?去"训练建议"</div><div class="text">训练负荷、训练课表和训练反馈组成训练闭环。</div></div>
</div>
...
<div class="tc-grid-4">
    <div class="tc-card">
        ...
        <div class="text">优先上传有功率数据的骑行记录;历史会长期保存,分析默认优先看最近 4-12 周。</div>
    </div>
    <div class="tc-card">
