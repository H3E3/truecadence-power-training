...
from tc_pages.v2.profile_modal import render_profile_edit_modal
...
def render_rider_profile_page(
    *,
    ...
    render_v2_page("profile", profile=profile)
    render_profile_edit_modal(profile=profile, user=user, rider=rider, load_rider_profile=load_rider_profile)
    st.stop()
